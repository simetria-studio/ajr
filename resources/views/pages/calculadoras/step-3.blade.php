        ...
        <div class="row my-5">
                ...
                <div class="col-4">
                    <div class="border  border-dark border-opacity-50 rounded text-center p-3 mb-3 shadow">
                        ...
                        <h4 class="fw-bold text-danger">{{ $produto->estados }}</h4>
                    </div>
                            ...
                            <div class="w-50  d-flex">
                                <div class="p-3">
                                    <div class="text-center mb-3">
                                        <h3 class="lh-1">{{ $produto->aliquota }}%</h3>
                                        <span>Alíquota</span>
                                    </div>
                                    <div class="text-center">
                                        <h3 class="lh-1">{{ $produto->fcp }}%</h3>
                                        <span class="fs-6">Fundo de Combate a <br> Pobreza</span>
                                    </div>
                                </div>
                                <div class="p-3">
                                    <div class="text-center mb-3">
                                        <h3 class="lh-1">{{ $produto->mva }}%</h3>
                                    ...
                                    <div class="text-center mb-2">
                                        ...
                                        <div class="d-flex ">
                                            <div class="px-2">
                                                <h6>{{ $produto->ajuste1 }}%</h6>
                                            </div>
                                            <div class="px-2">
                                                <h6>{{ $produto->ajuste2 }}%</h6>
                                            </div>
                                            <div class="px-2">
                                                <h6>{{ $produto->ajuste3 }}%</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="w-50">
                                <div class="p-3">
                                    <div class="text-center mb-4">
                                        <h5>Pauta Fiscal</h5>
                                        <span class="fw-3">{{ $produto->pauta }} R$</span>
